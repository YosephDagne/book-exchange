...
Since you mentioned using **XAMPP with MySQL on port 3306**, please follow these steps:

## Step 1: Start XAMPP MySQL

1. Open XAMPP Control Panel
2. Start the MySQL service
3. Ensure MySQL is running on **port 3306** (as you specified)
...
define('DB_PORT', '3306');  // Your XAMPP MySQL port
...
- MySQL is not running or not accessible on port 3306
